...
class GeoEnrollmentsList extends Model {

	public static function getFieldset(): Array {
		return [["label" => "ID", "name" => "_id", "type" => "number"], ["label" => "Regional", "name" => "_regional", "type" => "text"], ["label" => "Circuito", "name" => "_circuit", "type" => "text"], ["label" => "C&oacute;digo", "name" => "_budgetcode", "type" => "text"], ["label" => "Instituci&oacute;n", "name" => "_school", "type" => "text"], ["label" => "Poblado", "name" => "_town", "type" => "text"], ["label" => "Dependencia", "name" => "_dependence", "type" => "text"], ["label" => "Zona", "name" => "_zone", "type" => "text"], ["label" => "Tel&eacute;fono", "name" => "_phone", "type" => "tel"], ["label" => "Modalidad", "name" => "_enrollmentmode", "type" => "text"], ["label" => "Matr&iacute;cula", "name" => "_amount", "type" => "number"]];
	}
