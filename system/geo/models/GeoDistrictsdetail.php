...
class GeoDistrictsdetail extends Model {

	public static function getFieldset(): Array {
		return [["label" => "Identificador", "name" => "_id", "type" => "number"], ["label" => "Distrito", "name" => "_district", "type" => "number"], ["label" => "Poblaci&oacute;n", "name" => "_population", "type" => "text"], ["label" => "Econ&oacute;mica", "name" => "_economic", "type" => "text"], ["label" => "Electoral", "name" => "_voterturnout", "type" => "text"], ["label" => "Salud", "name" => "_health", "type" => "text"], ["label" => "Educaci&oacute;n", "name" => "_education", "type" => "text"], ["label" => "Seguridad", "name" => "_security", "type" => "text"], ["label" => "IDS", "name" => "_ids", "type" => "text"], ["label" => "A&ntilde;o", "name" => "_year", "type" => "number"]];
	}
