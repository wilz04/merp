<form id="fEditor" name="fEditor">
	...
	<div id="_ceeGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_cee">*Matrícula</label>
		<input type="number" class="form-control" id="_cee" name="_cee" required  value="{{ _cee|default('0') }}" />
	</div>
</form>
