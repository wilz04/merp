<form id="fEditor" name="fEditor">
	...
	<div id="_enGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_en">*Matrícula</label>
		<input type="number" class="form-control" id="_en" name="_en" required  value="{{ _en|default('0') }}" />
	</div>
</form>
