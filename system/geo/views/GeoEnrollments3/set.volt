<form id="fEditor" name="fEditor">
	...
	<div id="_biGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_bi">*BI</label>
		<input type="number" class="form-control" id="_bi" name="_bi" required  value="{{ _bi|default('0') }}" />
	</div>
	<div id="_seGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_se">*SE</label>
		<input type="number" class="form-control" id="_se" name="_se" required  value="{{ _se|default('0') }}" />
	</div>
	<div id="_pnGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_pn">*PN</label>
		<input type="number" class="form-control" id="_pn" name="_pn" required  value="{{ _pn|default('0') }}" />
	</div>
