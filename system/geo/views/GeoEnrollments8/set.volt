<form id="fEditor" name="fEditor">
	...
	<div id="_clGroup" class="form-group" style="display: {{ 'block'|default('block') }};">
		<label for="_cl">*CL</label>
		<input type="number" class="form-control" id="_cl" name="_cl" required  value="{{ _cl|default('0') }}" />
	</div>
