...
use Merp\Geo\Models\GeoEnrollments6List as _GET;
use Merp\Geo\Models\GeoEnrollments6List as _SET;
...
class GeoEnrollments6Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_caipad = $this->getViewStateValue("_caipad");
		return $model;
	}
