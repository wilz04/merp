...
use Merp\Geo\Models\GeoEnrollments3List as _GET;
use Merp\Geo\Models\GeoEnrollments3List as _SET;
...
class GeoEnrollments3Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_bi = $this->getViewStateValue("_bi");
		$model->_se = $this->getViewStateValue("_se");
		$model->_pn = $this->getViewStateValue("_pn");
