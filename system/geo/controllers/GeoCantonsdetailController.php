...
use Merp\Geo\Models\GeoCantonsdetailList as _GET;
use Merp\Geo\Models\GeoCantonsdetail as _SET;
use Merp\Geo\Models\GeoCantonsEnum as Enum_1;
...
class GeoCantonsdetailController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_canton = $this->getViewStateValue("_canton");
