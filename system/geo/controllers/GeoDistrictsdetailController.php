...
use Merp\Geo\Models\GeoDistrictsdetailList as _GET;
use Merp\Geo\Models\GeoDistrictsdetail as _SET;
use Merp\Geo\Models\GeoDistrictsEnum as Enum_1;
...
class GeoDistrictsdetailController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_district = $this->getViewStateValue("_district");
		$model->_population = $this->getViewStateValue("_population");
		$model->_economic = $this->getViewStateValue("_economic");
		$model->_voterturnout = $this->getViewStateValue("_voterturnout");
		$model->_health = $this->getViewStateValue("_health");
		$model->_education = $this->getViewStateValue("_education");
		$model->_security = $this->getViewStateValue("_security");
		$model->_ids = $this->getViewStateValue("_ids");
		$model->_year = $this->getViewStateValue("_year");
		return $model;
	}
	...
	private function dropdown(): void {
		$enum_1 = Enum_1::find(["order" => "_name"]);
		$this->view->setVar("enum_1", $enum_1);
	}
