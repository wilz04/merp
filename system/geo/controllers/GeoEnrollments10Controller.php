...
use Merp\Geo\Models\GeoEnrollments10List as _GET;
use Merp\Geo\Models\GeoEnrollments10List as _SET;
...
class GeoEnrollments10Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_coned = $this->getViewStateValue("_coned");
		return $model;
	}
