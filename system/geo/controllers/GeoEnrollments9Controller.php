...
use Merp\Geo\Models\GeoEnrollments9List as _GET;
use Merp\Geo\Models\GeoEnrollments9List as _SET;
...
class GeoEnrollments9Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_ec = $this->getViewStateValue("_ec");
		$model->_ee = $this->getViewStateValue("_ee");
