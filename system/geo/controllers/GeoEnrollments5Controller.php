...
use Merp\Geo\Models\GeoEnrollments5List as _GET;
use Merp\Geo\Models\GeoEnrollments5List as _SET;
...
class GeoEnrollments5Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_cee = $this->getViewStateValue("_cee");
		return $model;
	}
