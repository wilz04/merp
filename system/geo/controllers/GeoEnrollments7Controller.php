...
use Merp\Geo\Models\GeoEnrollments7List as _GET;
use Merp\Geo\Models\GeoEnrollments7List as _SET;
...
class GeoEnrollments7Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_en = $this->getViewStateValue("_en");
		return $model;
	}
