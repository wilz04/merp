...
use Merp\Geo\Models\GeoEnrollmentsList as _GET;
use Merp\Geo\Models\GeoEnrollments as _SET;
use Merp\Geo\Models\GeoSchoolsEnum as Enum_1;
use Merp\Geo\Models\GeoEnrollmentmodes as Enum_2;
...
class GeoEnrollmentsController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_school = $this->getViewStateValue("_school");
		$model->_enrollmentmode = $this->getViewStateValue("_enrollmentmode");
		$model->_year = $this->getViewStateValue("_year");
		$model->_amount = $this->getViewStateValue("_amount");
		return $model;
	}
	...
	private function dropdown(): void {
		...
		$enum_2 = Enum_2::find(["order" => "_description"]);
		$this->view->setVar("enum_2", $enum_2);
	}
