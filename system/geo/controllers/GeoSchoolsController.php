...
use Merp\Geo\Models\GeoSchoolsList as _GET;
use Merp\Geo\Models\GeoSchools as _SET;
use Merp\Geo\Models\GeoLocationsList as Enum_2;
use Merp\Geo\Models\GeoRegionals as Enum_3;
use Merp\Geo\Models\GeoDependences as Enum_6;
...
class GeoSchoolsController extends Controller {
	...
	private function dropdown(): void {
		$enum_2 = Enum_2::find(["order" => "_town"]);
		$this->view->setVar("enum_2", $enum_2);
	
		$enum_3 = Enum_3::find(["order" => "_name"]);
		$this->view->setVar("enum_3", $enum_3);
	
		$enum_6 = Enum_6::find(["order" => "_description"]);
		$this->view->setVar("enum_6", $enum_6);
	}
