...
use Merp\Geo\Models\GeoEnrollments2List as _GET;
use Merp\Geo\Models\GeoEnrollments2List as _SET;
...
class GeoEnrollments2Controller extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_ad = $this->getViewStateValue("_ad");
		$model->_ae = $this->getViewStateValue("_ae");
		$model->_pr = $this->getViewStateValue("_pr");
		$model->_rc = $this->getViewStateValue("_rc");
		$model->_pe = $this->getViewStateValue("_pe");
		$model->_pea = $this->getViewStateValue("_pea");
		return $model;
	}
