<?php
namespace Merp\Sys\Controllers;

use Merp\Sys\Models\SysSettings as _GET;
use Merp\Sys\Models\SysSettings as _SET;
...
class SysSettingsController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_key = $this->getViewStateValue("_key");
		$model->_value = $this->getViewStateValue("_value");
		return $model;
	}
