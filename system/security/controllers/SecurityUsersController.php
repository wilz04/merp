<?php
namespace Merp\Security\Controllers;

use Merp\Security\Models\SecurityUsersList as _GET;
use Merp\Security\Models\SecurityUsers as _SET;
...
class SecurityUsersController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_1stname = $this->getViewStateValue("_1stname");
		$model->_2ndname = $this->getViewStateValue("_2ndname");
		$model->_3rdname = $this->getViewStateValue("_3rdname");
		$model->_4thname = $this->getViewStateValue("_4thname");
		$model->_email = $this->getViewStateValue("_email");
		$model->_phone = $this->getViewStateValue("_phone");
		$model->_photo = $this->getViewStateValue("_photo");
		return $model;
	}
