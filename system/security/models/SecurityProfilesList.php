...
class SecurityProfilesList extends Model {

	public static function getFieldset(): Array {
		return [["label" => "Identificador", "name" => "_id", "type" => "number"], ["label" => "Nombre", "name" => "_name", "type" => "text"], ["label" => "Reservado", "name" => "_reserved", "type" => "text"]];
	}
