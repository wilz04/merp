<?php
namespace Merp\Catalog\Controllers;

use Merp\Catalog\Models\CatalogProductsList as _GET;
use Merp\Catalog\Models\CatalogProducts as _SET;
use Merp\Catalog\Models\CatalogCategoriesList as Enum_3;
...
class CatalogProductsController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_title = $this->getViewStateValue("_title");
		$model->_href = $this->getViewStateValue("_href");
		$model->_category = $this->getViewStateValue("_category");
		return $model;
	}
	...
	private function dropdown(): void {
		$enum_3 = Enum_3::find(["order" => "_title"]);
