...
use Merp\Catalog\Models\CatalogCategoriesList as _GET;
use Merp\Catalog\Models\CatalogCategories as _SET;
use Merp\Catalog\Models\CatalogCategoriesList as Enum_2;
...
class CatalogCategoriesController extends Controller {
	...
	private function dropdown(): void {
		$enum_2 = Enum_2::find(["order" => "_title"]);
