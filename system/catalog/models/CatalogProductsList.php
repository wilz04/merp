...
class CatalogProductsList extends Model {

	public static function getFieldset(): Array {
		return [["label" => "Identificador", "name" => "_id", "type" => "number"], ["label" => "T&iacute;tulo", "name" => "_title", "type" => "text"], ["label" => "Enlace", "name" => "_href", "type" => "text"], ["label" => "Categor&iacute;a", "name" => "_category", "type" => "text"]];
	}
