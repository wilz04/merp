...
class CatalogCategoriesList extends Model {

	public static function getFieldset(): Array {
		return [["label" => "Identificador", "name" => "_id", "type" => "number"], ["label" => "T&iacute;tulo", "name" => "_title", "type" => "text"], ["label" => "S&uacute;per-categor&iacute;a", "name" => "_category", "type" => "text"]];
	}
