<?php
namespace Merp\Matrix\Controllers;

use Merp\Matrix\Models\MatrixIndicators as _GET;
use Merp\Matrix\Models\MatrixIndicators as _SET;
...
class MatrixIndicatorsController extends Controller {
