<?php
namespace Merp\Info\Controllers;

use Merp\Info\Models\InfoRequestsList as _GET;
use Merp\Info\Models\InfoRequests as _SET;
...
class InfoRequestsController extends Controller {
	...
	private function getViewState(): _SET {
		...
		$model->_recvdate = $this->getViewStateValue("_recvdate");
		$model->_recvunit = $this->getViewStateValue("_recvunit");
		$model->_recvreceptor = $this->getViewStateValue("_recvreceptor");
		$model->_recvnotified = $this->getViewStateValue("_recvnotified");
		return $model;
	}
